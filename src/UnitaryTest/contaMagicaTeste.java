...
public class contaMagicaTeste {
    ...
    public void testeDepositoNegativo(){
        assertThrows(IllegalArgumentException.class, () -> conta.deposito(new BigDecimal(-1150000)));
    }

    @Test
    public void testeDepositoZero(){
        assertThrows(IllegalArgumentException.class, () -> conta.deposito(new BigDecimal(0)));
    }
